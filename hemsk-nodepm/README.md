...
1. Open your Community App Store repository on GitHub (e.g. `https://github.com/hemachandransk/my-umbrel-store`).
...
2. It pushes the image to:
   ```
   ghcr.io/<your-github-username>/hemsk-nodepm:latest
   ```
...
> docker build -t ghcr.io/hemachandransk/hemsk-nodepm:latest .
> ```
